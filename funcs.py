...
def plotting(x_A, y_A, n_char, ABC, BCE, CDEF, DFG, FGHI, HIJ, ACD, EFH, M_acd, M_efh, overlay='none'):
    # draw centerline
    y_centerline = 0
    x0 = x_A
    x1 = x_A + 15
    ...
    verts_acd = [(x_A, y_A), (x_BC[-1], 0), (x_D, y_D)]
    ...
    verts_efh = [(x_BC[-1], 0), (points_DFG[0][0][-1], points_DFG[0][1][-1]), (x_HI[0], y_HI[0])]
